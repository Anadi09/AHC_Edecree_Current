...
import com.eDecree.model.SecurityQuestion;
...
import com.eDecree.validation.UserMstrValidator;
...
public class UserController {
	...
	@RequestMapping(value = "/user/createDecree", method = RequestMethod.POST)	
	public @ResponseBody String createDecree(@RequestBody User um,HttpSession session) {	
		String jsonData="";
