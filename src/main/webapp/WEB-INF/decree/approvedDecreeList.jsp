			...
			<div class="col-md-12">
				...
				<div class="panel panel-inverse">
					<div class="panel-heading">
						...
						<h4 class="panel-title">Approved Decree List</h4>
					</div>
					<div class="panel-body">
						<div class="table-responsive">
							<table id="data-table" class="table table-striped table-bordered"
								ng-init="getApproveDecreeList()">
								<thead>
									<tr>
										<th>Sr.<br>No
										</th>
								...
								<tbody>
									<tr 
										ng-repeat="row in approvedDecreeList" class="odd gradeX">
										<td>{{$index+1}}</td>
										<td>{{row.ct_label}}</td>
										...
										<button class="btn btn-primary rounded-pill btn-sm"
                                              ng-click="viewApproveDocument(row.df_fd_mid)">Preview</button>
...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/scripts/controllers/notice/NoticeController.js?v=3"></script>
