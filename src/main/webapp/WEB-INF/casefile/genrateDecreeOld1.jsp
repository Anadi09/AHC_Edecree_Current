...
<link
	href="https://fonts.googleapis.com/css2?family=Noto+Sans+Devanagari&family=Hind&display=swap"
	rel="stylesheet">

<style>
body, textarea, div, span, p {
...
<body>
	...
	<div id="pdfcontent" class="content">
		<div class="container-fluid" ng-controller="NoticeController"
			...
			<input type="hidden" class="form-control" value=${doc_id
				...
				id="doc_id" name="doc_id"> <input type="hidden"
				id="loggedUserId" value="<%=user.getUm_id()%>">
					...
					<div class="panel-body">
						<form class="form-horizontal reduce-gap" name="generateDecree"
							...
							<div class="modal-body">
								...
								<div id="target1" ng-show="decreeForm==null"
									...
									<div align="left">
										<h5>
											...
											<!-- <span ng-show="lowerDetails==null">District Judge of district</span> <span ng-show="lowerDetails!=null">{{lowerDetails.judgeName}}
										 of {{lowerDetails.distName}}</span>. dated
											{{lowerDetails.decisionDate}} ,in 
											<span ng-show="lowerDetails==null">enter lower court case details</span>
											<span ng-show="lowerDetails!=null">{{lowerDetails.caseTypeName}}</span> no {{lowerDetails.caseno}} of {{lowerDetails.caseYear}} -->
										</h5>
									</div>
									<div align="left">
								...
								<div ng-show="decreeForm==null"
									style="border-style: double; padding-right: 25px; padding-left: 25px; padding-top: 30px;page-break-before:always;">
									<div contenteditable="true" id="target2">
										...
										<h5 align="center">{{advocates.petAdvocate}}</h5>
										...
										<h5 align="center">{{advocates.resAdvocate}}</h5>
								...
								<div
									style="border-style: double; padding-right: 25px; padding-left: 35px; padding-top: 30px;page-break-after:always; ;"
									...
									<div id="target3" contenteditable="true">
										...
										<div style="margin-top: 400px;">
											...
											<h5 style="text-align: justify;">
												...
												the respondent no. / appellant no. ---- aforesaid the sum of
												Rs. --- the amount of cost incurred by --- in this Court.
												And it is further ordered that appellant no. respondent no.
												---- aforesaid do pay to the respondent no. / appellant
								...
								<div ng-show="decreeForm==null"
									style="border-style: double; padding-right: 25px; padding-left: 35px; padding-top: 10px; page-break-after: always;"
									contenteditable="true">
							...
							<div align="center">
								...
								<button
								 ...
								 || decreeForm.df_stage_lid==4004  || decreeForm.df_stage_lid==4008
								...
								<br /> <select class="form-control" ng-model="assign_to"
									style="width: 250px" ng-show="isAssignedUser()"
								...
								<button class="btn btn-success btn-sm"
									ng-show="isAssignedUser()" ng-click="nextStage(4001)">
									Assign To</button>
								<br />
								<button ng-show="isAssignedUser()" class="btn btn-success"
									data-toggle="modal" data-target="#returntodecree">
							...
							<button ng-show="decreeForm.df_stage_lid!==null"
								class="btn btn-success btn-sm" ng-click="generatePdf()">Preview</button>
								
								<button ng-show="decreeForm.df_stage_lid!==null"
								class="btn btn-success btn-sm" ng-click="downloadDecreeJs()">Preview_Js</button>
					</div>
				</div>
			</div>
			</form>
	...
	<div id="pdfTemp"
		style="position: absolute; left: -9999px; top: 0; width: 800px; background: white;"></div>
	<!-- end row -->
</body>
...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/scripts/controllers/notice/NoticeController.js?v=6"></script>
...
<script src="NotoSansDevanagari-Regular.js"></script>
<script type="text/javascript"
