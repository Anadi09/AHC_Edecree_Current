...
<%-- <link rel="stylesheet" href="${pageContext.request.contextPath}/js/viewerHeader/viewerheader.css" />
 --%><script src="${pageContext.request.contextPath}/js/pdfjs/web/compatibility.js"></script>


<!-- This snippet is used in production (included from viewer.html) -->
<link rel="resource" type="application/l10n" href="${pageContext.request.contextPath}/js/pdfjs/web/locale/locale.properties" />
<script src="${pageContext.request.contextPath}/js/pdfjs/web/l10n.js"></script>
<script src="${pageContext.request.contextPath}/js/pdfjs/build/pdf.js"></script>
<script src="${pageContext.request.contextPath}/js/pdfjs/web/debugger.js"></script>
<script src="${pageContext.request.contextPath}/js/pdfjs/web/viewer.js?v=5"></script>

<div tabindex="1" class="loadingInProgress" style="height: 450px; ">
    <div id="outerContainer">
       <!--  <div id="sidebarContainer" style ="top:70px; position:sticky; z-index: 1;"> -->
        ...
        <div id="mainContainer">
          ...
          <!--   <div class="toolbar page-header-fixed in"> -->
            <!--  <div class="toolbar" id ="pdfToolBar" style ="top:9%; position: sticky; z-index: 1;"> -->
             <div class="toolbar" id ="pdfToolBar"  style ="top:50.2px; position:sticky; z-index: 1;">
              ...
              <span data-l10n-id="download_label">Download</span>
                    ...
                    <button id="documentProperties" class="secondaryToolbarButton documentProperties" title="Document Properties…" tabindex="61" data-l10n-id="document_properties">
                        ...
                        <div id="toolbarViewerLeft">
                           ...
                           <select id="pageNumber"  tabindex="15" class="dropdownToolbarPage"></select>                          
                        ...
                        <div id="toolbarViewerRight">
                            <button  style="display:none" id="presentationMode" class="toolbarButton presentationMode hiddenLargeView" title="Switch to Presentation Mode" tabindex="31" data-l10n-id="presentation_mode">
                             ...
                             <button  id="btnPresent" class="toolbarButton presentationMode hiddenLargeView" title="Switch to Presentation Mode" tabindex="31" data-l10n-id="presentation_mode">
                                <span data-l10n-id="presentation_mode_label">Presentation Mode</span>
                            </button>
