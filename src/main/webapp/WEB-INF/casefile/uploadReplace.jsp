...
<form class="form-horizontal reduce-gap" name="masterForm" novalidate enctype="multipart/form-data" role="form">      
	<div class="modal-body">
		<div class="row">							  			      		
				<div class="form-group">
							...
							<input required type="file" ngf-select ng-model="picFile" name="file"  >
				 </div>
		</div>
	...
	<div class="modal-footer"> 
		<div>
		<input type="submit" value="Submit" ng-disabled="masterForm.$invalid" ng-click="fileReplace(data.sd_id)"   class="btn btn-success"/>      
