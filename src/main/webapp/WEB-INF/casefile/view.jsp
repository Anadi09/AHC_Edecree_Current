...
%> 
  ...
  <button class="btn btn-success btn-sm" ng-click="viewAllOrders()" style ="position:sticky; top:90.2px;">View All Orders</button> 
   ...
   <button class="btn btn-success btn-sm" ng-click="left()" style ="position:sticky; top:90.2px;">Left</button> 
...
<%
	if (role.equals("DMSAdmin") || role.equals("ECOURT") || role.equals("Judge") || role.equals("CaueList_Uploader") ) {
%>
<button class="btn btn-success btn-sm" ng-click="downloadfiles()" style ="position:sticky; top:90.2px;">DownloadFile</button>

<button class="btn btn-success btn-sm" id="btn" style ="position:sticky; top:90.2px;">fullscreen</button>
...
%> 
                                    ...
                                    <div class="panel-body" style ="padding-top:0px;">
                                        ...
                                        <% if(role.equals("DMSAdmin") || role.equals("ECOURT") || role.equals("Judge")  ) {%>
                                            ...
                                            <%} %>
                                                ...
                                                <% if( role.equals("DECREE CREATOR") || role.equals("Deputy Registrar(Decree)") )   {%>
                                                    <div class="col-md-8" id="myDiv">
                                                      <link href="${pageContext.request.contextPath}/assets/css/custom.css" rel="stylesheet" />	
                    ...
                    <script type="text/javascript" src="${pageContext.request.contextPath}/js/scripts/controllers/CaseFileViewController.js?v=10"></script>
