...
<body>
						...
						<form class="form-horizontal reduce-gap" name="generateDecree"
							...
							<div id="pdfContent">
								...
								<div ng-show="decreeForm==null"
									...
									<!-- <div><textarea id="txtEditor2" name="abc" ng-model="TemplateDescription" placeholder="Please Don't Use Special Characters" hidden></textarea>
										<div id="editorjs"></div>
	...
	<!-- <div hidden="true">
		  <label for="pdfData">Pdf Data(Base64)):</label>
            ...
            <div class="well-sm">
          <label for="signedPdfData">Signed Pdf Data(Base64):</label>
          <br />
          <textarea placeholder="After signing, the encrypted signature will be shown here..." id="signedPdfData" cols="60" rows="8" disabled></textarea>
        </div>
        
        <br />  <input type="text" id="tsaURL" name="tsaURL" value="" maxlength="100" style="width: 400px;" />
            <br /> <input type="hidden" id="timeServerURL" name="timeServerURL" value="http://localhost:8080/dscapi/getServerTime" maxlength="100" style="width: 400px;" />
            <br />
		</div> -->
	</div>
