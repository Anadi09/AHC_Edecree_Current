<%@ include file="../content/header2.jsp"%>
                            ...
                            <table id="data-table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <tr ng-repeat="row in caseFileList" class="odd gradeX">
                                        ...
                                        <td>
                                            <!-- <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" ng-click="getStages(row)" data-target="#stageHistory"> -->History </button> -->
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/scripts/controllers/CaseFileController.js"></script>
