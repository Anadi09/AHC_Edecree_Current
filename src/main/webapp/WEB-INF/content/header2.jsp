...
<div id="page-container" class="fade page-sidebar-fixed page-header-fixed" style ="padding-top:35px">
		...
		<!-- 	<div class="container-fluid" > -->
				...
				<div class="navbar-header">
					<a href="" class="navbar-brand" style ="height:35px"><span class="navbar-logo"></span>Allahabad High Court e-Decree <span style ="padding-left: 30px; font-style: italic;
    font-size: 20px;" id ="listType"></span>   <span style ="padding-left: 20px; color:red ;font-weight: bold;
    font-size: 25px;" id ="serial"></span></a>
			...
			%>
				<div class="navbar-header" id="slidebar" style="padding-top: 10px;" >
						<label class="toggle">
						...
						<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
							...
							%>
								...
								{%>
								 ...
								 --%>
								 <span class="hidden-xs"><b><%=""%></b><b><%=capitalizeWord(user.getUm_fullname()) %>(<%=chamberName%>)</b></span> <b class="caret"></b>
						 ...
						 for(int i=0;i<parent_list.size();i++)
						 {
							...
							if(om.getOm_object_stages()==0)
							{
								...
								<li class="has-sub" >
		                        	 ...
		                        	 <ul class="sub-menu">
			                        	 <%if(om.getOm_id().equals(7L) && role.contains("DECREE CREATOR"))
			                        	 {System.out.print("in itttttttt");
			                        	 %>
									 		...
									 		for(int j=0;j<child_list.size();j++)
											 {
												 ...
												 {													 
													 ...
													 //add child
														 ...
														 <%
														 if(role !=null && role.equals("DECREE CREATOR")){
														 %>                 	 
			                        	 
														 <li  class=<%=active %>><a style ="font-weight: bold;" target="_blank" href="http://192.168.0.178/pdms/searchfileDestructed">Digitized File </a></li>
