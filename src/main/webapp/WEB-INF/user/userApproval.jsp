		...
		<div class="row">
			...
			<div class="panel panel-inverse">
				<div class="panel-heading">
					...
					<h4 class="panel-title">User Approval</h4>
				</div>
				...
				<div class="row">
					...
					<div class="table-responsive">
						<table st-table="displayedCollection" st-safe-src="masterdata"  class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
								<th st-sort="username">User Id</th>
								<th st-sort="um_pass_validity_date">User Name</th>
								<th st-sort="um_account_activation">Designation</th>
								<th st-sort="um_account_activation">Section</th>
								<th style="width: 20%;" class="text-center">Action</th>					
								</tr>
							</thead>
							<tbody>
								<tr ng-repeat="data in userApprovalData">
								<td>{{data.hcu_office_id}}</td>
								<td>{{data.hcu_username}}</td>
								<td>{{data.hcd.hcd_name}}</td>
								<td>{{data.hcs.hcs_section_id}}</td>
								...
								<!-- <a class="btn btn-info btn-xs" ng-click="Refresherrorlist(data)" data-toggle="modal" data-target="#pass_Modal" ><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>Change Password</a> -->
									<a class="btn btn-info btn-xs" ng-click="approveUser(data)"  ><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>Approved User</a>
								</td>
								</tr>
							</tbody>
							<tfoot>
