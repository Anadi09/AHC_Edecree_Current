...
/*	$scope.left = function (){
		...
		document.getElementById("sidebar").style.hidden ="true";
		
		document.getElementById("content").style.marginLeft ="0px";
		document.getElementById("content").style.marginRight ="180px";
		
		
		document.getElementById("sidebarContent").style.hidden ="false";
		//document.getElementById("sidebarContent").style.left ="0";
		document.getElementById("sidebarContent").style.right ="0";
		document.getElementById("sidebar").style.left =null;
		document.getElementById("sidebar").style.right ="0";
		console.log(document.getElementById("sidebarContent").style);
		document.getElementById("sidebar").style.width =180+"px";
		document.getElementById("sidebar").style.hidden ="false";
		...
		$http.get(urlBase+'casefile/getsubdocuments/'+$scope.doc_id).success(function (data) {
	    	...
	    	angular.forEach($scope.subDocuments, function(value, key) {
	    		  ...
	    		  case'rejoinder':
	    			  ...
	    			  break;
	    		  case'Decree':
	    			  $scope.decree.push($scope.subdocument);
	    			  break;
	    		  case'application':
	        ...
	        $scope.decreeData = [].concat($scope.decree);
